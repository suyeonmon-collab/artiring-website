...
export const notices = [
  {
    slug: 'terms-privacy-change-20261023',
    title: '[사전공지] 이용약관·개인정보처리방침 변경 안내',
    summary:
      '2026년 10월 23일부터 이용약관·개인정보처리방침이 변경·시행됩니다. 불리한 변경에 해당하는 조항이 포함되어 30일 전 사전고지합니다.',
    category: 'notice',
    status: 'published',
    date: '2026-09-23',
    href: '/support/notices/terms-privacy-change',
    highlight: true,
    note: '공지일 2026.09.23 · 시행일 2026.10.23 (30일 전 고지)',
  },
  {
    slug: 'terms',
    title: '이용약관 (Meowmo)',
    ...
    href: '/terms',
    highlight: true,
    note: '시행일 2026.10.23 · 앱 내 약관과 동일',
  },
  {
    slug: 'privacy',
    ...
    href: '/privacy',
    highlight: true,
    note: '시행일 2026.10.23 · 앱 내 방침과 동일',
  },
  {
